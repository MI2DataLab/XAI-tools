...
cp_ranger <- ceteris_paribus(ranger_model, data = titanic_imputed, variables = "fare", predict_function = pred_fun_ranger, new_observation = titanic_imputed)
...
cp_ranger <- ceteris_paribus(ranger_model, data = titanic_imputed, predict_function = pred_fun_ranger, new_observation = titanic_imputed[1,])
...
cp_ranger <- ceteris_paribus(ranger_model, data = titanic_imputed, variables = "fare", predict_function = pred_fun_ranger, new_observation = titanic_imputed[1,])
plot(cp_ranger)
```